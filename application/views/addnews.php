	...
	<body class="quick-bold">
		...
		<div class="container" style="margin-top:50px">
			...
			<?php 	$attribute = array('id'=>'account_form','style'=>'margin-left:30px');
							echo form_open('dashboard/validate_new_news',$attribute);?>
					<fieldset>			
						<legend ><h3>Create a new Update/News:</h3></legend>
						<div id = "notes">	
							...
							<div class="control-group" >
							  <!-- Text input-->
								<label class="control-label" for="input01">
									...
									<div class="controls">
										<input type="text" placeholder="" class="span12" name = "titles" id = "titles" value = ""/>
									</div>
							</div>
						...
						<div class="control-group" >
						  <!-- Text input-->
							<label class="control-label" for="input01">
								...
								<div class="controls">
									<textarea placeholder="" class="span12" name = "contents" id = "contents" style = "resize:none;height:200px"></textarea>
								</div>
						</div>						
				<?php echo form_close();?>		
