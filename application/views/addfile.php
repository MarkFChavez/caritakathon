	...
	<body class="quick-bold">
		...
		<div class = "row-fluid">
			<div class = "span7 offset5">
				<?php echo form_open_multipart('dashboard/validate_files'); ?>
						<p>
						<?php echo form_label('File 1: ', 'file1','style="margin-top:5%"') ?>
							<?php echo form_upload('file1','') ?>
						</p>
						<p>
							<?php echo form_label('File 2: ', 'file2','style="margin-top:5%"') ?>
							<?php echo form_upload('file2','') ?>
						</p>
						<p>
							<?php echo form_label('File 3: ', 'file3','style="margin-top:5%"') ?>
							<?php echo form_upload('file3','') ?>
						</p>
						<p>
							<?php echo form_label('File 4: ', 'file4','style="margin-top:5%"') ?>
							<?php echo form_upload('file4','') ?>
						</p>						
						<p><?php echo form_submit('submit', 'Upload!','class="btn btn-inverse"') ?></p>
					 <?php echo form_close() ?>				
			</div>
		</div>	
			</div>		
